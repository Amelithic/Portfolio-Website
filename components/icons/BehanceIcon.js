export default function BehanceIcon() {
    return (
        <svg width="25pt" height="25pt" viewBox="-127 175.8 256 162.2" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="var(--text-color)">
            
            <title>Behance.net/Amelithic</title>
